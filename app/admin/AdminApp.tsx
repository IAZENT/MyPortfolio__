...
function ProjectsAdmin({ supabase }: { supabase: ReturnType<typeof createBrowserSupabaseClient> }) {
...
function BlogAdmin({ supabase }: { supabase: ReturnType<typeof createBrowserSupabaseClient> }) {
  const [q, setQ] = useState("");
  const [loading, setLoading] = useState(true);
...
function CertsAdmin({ supabase }: { supabase: ReturnType<typeof createBrowserSupabaseClient> }) {
  const [loading, setLoading] = useState(true);
...
function SkillsAdmin({ supabase }: { supabase: ReturnType<typeof createBrowserSupabaseClient> }) {
  const [loading, setLoading] = useState(true);
...
function ServicesAdmin({ supabase }: { supabase: ReturnType<typeof createBrowserSupabaseClient> }) {
  const [loading, setLoading] = useState(true);
...
function TestimonialsAdmin({ supabase }: { supabase: ReturnType<typeof createBrowserSupabaseClient> }) {
  const [loading, setLoading] = useState(true);
...
function MediaAdmin({ supabase }: { supabase: ReturnType<typeof createBrowserSupabaseClient> }) {
  const [loading, setLoading] = useState(true);
...
function MessagesAdmin({ supabase }: { supabase: ReturnType<typeof createBrowserSupabaseClient> }) {
  const [loading, setLoading] = useState(true);
...
function SettingsAdmin({ supabase }: { supabase: ReturnType<typeof createBrowserSupabaseClient> }) {
  const [loading, setLoading] = useState(true);
...
function UsersAdmin({ supabase }: { supabase: ReturnType<typeof createBrowserSupabaseClient> }) {
  const [loading, setLoading] = useState(true);
